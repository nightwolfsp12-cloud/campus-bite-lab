      ...
      <div className="container mx-auto px-4 py-6">
        ...
        >
          <Button
            variant="ghost"
            size="sm"
            onClick={currentScreen === 'overview' ? onBack : () => setCurrentScreen('overview')}
          ...
          >
            {[
              ...
              <Button
                ...
                className={currentScreen === tab.id 
                  ? 'bg-primary hover:bg-primary-glow whitespace-nowrap' 
                  : 'border-white/30 hover:bg-white/10 whitespace-nowrap'
                }
              >
